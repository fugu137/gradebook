...
You can download and try it here: https://github.com/fugu137/gradebook/releases/download/v0.9.0/gradebook.exe. (Sample class lists and a sample save file can be found by clicking `Releases > Assets` on this page and downloading the `.csv` and `.gbk` files.)
