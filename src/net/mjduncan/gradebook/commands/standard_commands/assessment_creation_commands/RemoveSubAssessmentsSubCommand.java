...
import net.mjduncan.gradebook.model.SubAssessmentColumn;
...
//        int numberToRemove = oldQuantity - newQuantity;
    ...
    private ButtonType displayAlertAndReturnResponse(int numberToRemove) {
        ...
        alert.getDialogPane().getStylesheets().add(getClass().getResource("/net/mjduncan/gradebook/dialog-pane.css").toExternalForm());
